...
Exécute l'équivalent de:
    from underautomation.abb.xxx import *
pour tous les modules et sous-packages découverts récursivement.

Usage:
    python tests/test_import_all.py [nom_du_package]

Exemples:
    python tests/test_import_all.py
    python tests/test_import_all.py underautomation.abb
...
def main():
    ...
    package_name = sys.argv[1] if len(sys.argv) > 1 else "underautomation.abb"
